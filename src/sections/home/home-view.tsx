...
const BackgroundSVG = styled('svg')({
  ...
  '@keyframes lavaFlow': {
    ...
    '25%': { transform: 'translate(150px, 150px) scale(1.8)' },
    '50%': { transform: 'translate(-150px, -150px) scale(1.3)' },
    '75%': { transform: 'translate(100px, -100px) scale(1.5)' },
...
export function HomeView() {
  return (
    <HeroContainer>
      ...
      >
        <rect width="1440" height="1080" fill="url(#pattern0_1_2)" fillOpacity="0.42" />
        <defs>
